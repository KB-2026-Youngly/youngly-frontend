<template>
  ...
  <article class="forecast-card yl-card-frame pixel-step-card">
...
<style scoped>
.forecast-card { --pixel-outline-width:2px; --pixel-outline-color:#ac99d2; --pixel-fill:#fff; min-height: 330px; padding: 28px; position: relative; overflow: hidden; }
...
.notice-pill{box-sizing:border-box;justify-content:center;border:2px solid #d9d0e5;border-radius:999px!important;background:#fff}
</style>
