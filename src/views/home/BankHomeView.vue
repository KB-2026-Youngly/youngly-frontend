...
.youngly-banner{min-height:190px!important;padding:27px 34px!important;justify-content:space-between!important;isolation:isolate;border:0!important;border-radius:0 0 26px 26px!important;background:#7156ad!important;box-shadow:0 15px 32px rgba(73,45,120,.2);color:#fff!important}
